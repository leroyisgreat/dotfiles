...
-- {{{ Variable definitions
    ...
    --beautiful.init(awful.util.get_themes_dir() .. "vapor1/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "n",
      ...
      -- ALSA volume control
      -- Even though you may use PulseAudio, it's generally
      --  better and faster to control it directly from ALSA
...
awful.rules.rules = {
    ...
    { rule_any = {
        instance = {
          ...
          "cerebro", -- Open source Spotlight application
        },
        class = {
          "Arandr",
          "Gpick",
